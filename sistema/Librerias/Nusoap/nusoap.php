...
//		}
	...
	* @access   public
	*/
	function send($data, $timeout=120, $response_timeout=120, $cookies=NULL) {
...
class wsdl extends nusoap_base {
     ...
     * @access public 
     */
    function wsdl($wsdl = '',$proxyhost=false,$proxyport=false,$proxyusername=false,$proxypassword=false,$timeout=0,$response_timeout=120,$curl_options=null,$use_curl=false){
		parent::nusoap_base();
