...
<head>
    ...
    <!-- Uso solo del modulo -->
    <script type="text/javascript" src="{$path}/vistas/Home/js/recupera.js" ></script>
</head>
<body>
    <section class="container">
        <div class="login">
            <h1>{$tituloacceso}</h1>
            <form id="recupera_login_form" method="post" action="#">
                <p><input type="text" name="recupera_email_usr" id="recupera_email_usr" value="" placeholder="{$inputEmail}"></p>
                <p></p>
                <p class="submit"><input type="submit" name="commit" value="{$botonRecuperar}" onclick="return recuperaPassword();"></p>
            </form>
        </div>
