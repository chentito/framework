...
<body>
    <section class="container">
        <div class="login">
            ...
            <form id="cliente_login_form" method="post" action="#">
                <p><input type="text" name="cliente_login_usr" id="cliente_login_usr" value="" placeholder="{$inputUsuario}"></p>
                <p><input type="password" name="cliente_login_passwd" id="cliente_login_passwd" value="" placeholder="{$inputPasswd}"></p>
                <p class="remember_me">
                <label>
                    <input type="checkbox" name="cliente_login_remember_me" id="cliente_login_remember_me">
                    {$recordarme}
                </label>
                </p>
    ...
    <!-- Uso local -->
    <script src="{$path}/vistas/Home/js/empleadosLogin.js"></script>
    <section class="about">
